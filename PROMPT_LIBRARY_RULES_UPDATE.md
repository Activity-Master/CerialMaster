...
- Library name: Cerial Master
- Current/new version: 3.0.0-SNAPSHOT
- Repository URL / path: https://github.com/Activity-Master/CerialMaster.git
- Rules Repository Location: rules (submodule)
- Rules Repository target path for generated artifacts (relative to the Rules Repository root): generative/data/activity-master/cerial
- Short description: Activity Master addon library for serial port configuration and lifecycle (GuicedEE, Vert.x 5, Mutiny)
- Type:
...
- Component/topic areas (list): Activity Master Core/Client/Cerial/Cerial Client; GuicedEE Core/Client/Cerial; Vert.x 5 Reactive; CRTP Fluent API; Lombok/Log4j2 Logging; MapStruct; JSpecify; Jacoco; Java Micro Harness; GitHub Actions CI
