...
- Repository URL / local path: https://github.com/Activity-Master/CerialMaster.git
- Org and project name: ActivityMaster / Cerial Master
- Short description: An addon for the Activity Master Core to manage persistence of serial port configuration and management exposed with the Cerial Client
